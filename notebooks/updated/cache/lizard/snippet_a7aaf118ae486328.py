def mod_run_check(cmd_kwargs, onlyif, unless):
    ...
    cmd_kwargs.update({'use_vt': False, 'bg': False, 'ignore_retcode': True,
        'python_shell': True})
        ...
        for command in onlyif:
            ...
            try:
                ...
                return {'comment':
                    ...
                    format(exc), 'result': False}
            return {'comment': 'onlyif condition is false', 'skip_watch':
                True, 'result': True}
    if unless is not None:
        ...
        for command in unless:
            ...
            return {'comment': 'unless condition is true', 'skip_watch':
                True, 'result': True}
    return True