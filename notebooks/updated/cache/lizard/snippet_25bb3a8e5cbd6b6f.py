def encode_list(data, encoding=None, errors='strict', keep=False,
    ...
    for item in data:
        if isinstance(item, list):
            ...
            item = encode_tuple(item, encoding, errors, keep,
                preserve_dict_class) if preserve_tuples else encode_list(item,
                encoding, errors, keep, preserve_dict_class, preserve_tuples)
